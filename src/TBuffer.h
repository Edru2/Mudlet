...
public:
    ...
    void addLink(bool, const QString& text, QList<TLink>& command, QStringList& hint, TChar format);
    ...
    bool applyLink(const QPoint& P_begin, const QPoint& P_end, const QList<TLink>& linkFunction, const QStringList& linkHist);
